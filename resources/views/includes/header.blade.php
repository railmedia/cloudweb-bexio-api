<header>
    ...
    <nav aria-label="menu nav" class="bg-gray-800 pt-2 md:pt-1 pb-1 px-1 mt-0 h-auto fixed w-full z-20 top-0">
        ...
        <div class="flex flex-wrap items-center">
            ...
            <div class="flex w-full pt-2 mr-2 content-center justify-between md:w-1/3 md:justify-end">
                <div class="text-white mr-2">
                    <a href="{{ route('download.basket') }}" style="font-size: 20px;" title="Download basket">
                        <i class="fa-solid fa-download"></i>
                    </a>
                </div>
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white dark:text-gray-400 dark:bg-gray-800 hover:text-gray-400 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
